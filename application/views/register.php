                        ...
                        <ul class="nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="/auth/register"><i class="icon-user"></i> Login / Register</a></li><!-- Only visible if logged out -->
                   		...
                   		<div class="control-group">
                            ...
                            <div class="controls">
                            	<div class="input-prepend">
                                    ...
                                    </span><input class="span4" style="width: 330px;" name="email" id="inputIcon" type="email" />
                                    
                                </div>
                            </div><input type="hidden" name="process" value="login" />
                            <label class="control-label" for="inputIcon2"><strong>Password</strong></label>
                            <div class="controls">
                            	<div class="input-prepend">
                                	<span class="add-on">
                                    	<i class="icon-asterisk"></i>
                                    </span><input class="span4" name="pass" style="width: 330px;"id="inputIcon2" type="password" />
                                </div>
                            </div>
                   		...
                   		<div class="control-group">
                            ...
                            <div class="controls">
                            	<div class="input-prepend">
                                	<span class="add-on">
                                    	<i class="icon-envelope"></i>
                                    </span><input class="span4" name="email" style="width:330px;" id="inputIcon" type="email" />
                            ...
                            <div class="controls">
                            	<div class="input-prepend">
                                	<span class="add-on">
                                    	<i class="icon-asterisk"></i>
                                    </span><input class="span4" name="passconf" style="width:330px;" id="inputIcon3" type="password" />
                                </div>
                            </div>
                            <div class="pull-right">
